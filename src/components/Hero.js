        ...
        <div className={classes.inner}>
          <div className={classes.content}>
            ...
            <Text color="dimmed" mt="md">
              Build fully functional accessible web applications faster than ever – Mantine includes more than 120 customizable components and hooks
          ...
          <Image src="images/logo.png" className={classes.image} />
        </div>
      </Container>
    </div>
  );
